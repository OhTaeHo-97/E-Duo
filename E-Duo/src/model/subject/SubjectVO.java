...
public class SubjectVO {
	...
	public void setFirst_end(String first_end) {
	...
	public String getThird_start() {
		return third_start;
	}
	public void setThird_start(String third_start) {
		this.third_start = third_start;
	}
	public String getThird_end() {
		return third_end;
	}
	public void setThird_end(String third_end) {
		this.third_end = third_end;
	}
}
