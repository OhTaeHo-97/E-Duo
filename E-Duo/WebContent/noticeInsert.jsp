...
<div class="site-wrap">
    ...
    <div class="site-section">
      <div class="container">
        ...
        <div>
        	...
        	<form action="insertNotice.notice" method="POST">
	...
	<%--                     <span class = "time">${notice_data.regDate}</span> --%>
	            ...
	            <div class="form-group row">
	                <div class="col-md-12">
	                	<h6>내용</h6>
	                	<textarea name = "content" rows = "10" cols = "135" style = "resize: none;"></textarea>
	                </div>
	            </div>
	            <div class="form-group row">
	                <div class="col-md-3">
	                ...
	                <div class="col-md-3">
	                	<input type="button" class="btn btn-primary btn-lg btn-block" value="돌아가기" onClick = "location.href = 'noticePage.notice'">
	                </div>
	            </div>
	            <!-- <div class="form-group row">
	                <div class="col-lg-12">
