...
<body>
    ...
    <div class="site-section">
      <div class="container">
        <div>
          <div class="col-md-12">
            <h2 class="h3 mb-3 text-black">수강 과목 찾기</h2>
          </div>
          <div class="w-100">
             <div class="p-3 p-lg-5 border" style="height: 100%;">
               <div class="form-group row">
                 <div class="col-md-9">
                   <input type="text" class="form-control" id="srch_subject" name="subject" placeholder = "과목을 입력하세요.">
                 </div>
                 <div class="col-md-3">
                   <input type="button" id="searchSub" class="btn btn-secondary btn-sm dropdown-toggle" value="검색">
                 </div>
               </div>
               <div class="form-group row">
                 <div class="col-md-12">
                   <ul name="sub_list" id="sub_list">
