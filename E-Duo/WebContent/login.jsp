            ...
            <form action="login.mem" method="POST" name = "loginForm" id = "loginForm" onsubmit = "return login_check()">
              ...
              <div class="p-3 p-lg-5 border">
                <div class="form-group row">
                  <div class="col-md-12">
                    <label for="login_sid" class="text-black">ID <span class="text-danger">*</span></label>
                    <input type="text" class="form-control" id="login_sid" name="sid" placeholder="아이디를 입력하세요.">
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-md-12">
                ...
                <div class="form-group row">
					...
					<div class="col-md-6" align="right">
					  	<input type = "radio" name = "auth" value = "s" checked> 학생&nbsp;&nbsp;&nbsp;
					  	<input type = "radio" name = "auth" value = "a"> 관리자
					</div>
                </div>
                <div class="form-group row">
                  <div class="col-md-6">
